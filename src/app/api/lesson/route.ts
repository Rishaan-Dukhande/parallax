...
const LESSON_META: Record<string, {
  ...
  '501': { unitName: 'Universal Gravity', lessonName: "Newton's Law of Gravity", concept: "gravitational force between masses using Newton's law F = Gm₁m₂/r²", prerequisites: ["Newton's Laws"], keyFacts: ["F = Gm₁m₂/r²", "Force decreases with square of distance", "Every mass attracts every other mass"] },
  '502': { unitName: 'Universal Gravity', lessonName: 'Gravitational Fields', concept: 'gravitational field as force per unit mass g = F/m', prerequisites: ["Newton's law of gravity"], keyFacts: ["g = GM/r²", "Field exists around every mass", "Earth's surface g = 9.8 m/s²"] },
  '503': { unitName: 'Universal Gravity', lessonName: 'Orbital Motion', concept: 'orbital motion as continuous free fall around a body', prerequisites: ['gravitational fields'], keyFacts: ["Orbit = falling but missing the ground", "v = √(GM/r) for circular orbit", "Faster orbit = lower altitude"] },
  '504': { unitName: 'Universal Gravity', lessonName: 'Escape Velocity', concept: 'minimum speed needed to escape a gravitational field', prerequisites: ['orbital motion'], keyFacts: ["v_escape = √(2GM/r)", "Earth escape velocity = 11.2 km/s", "Black holes: escape velocity > c"] },
  '601': { unitName: 'Oscillations', lessonName: 'Simple Harmonic Motion', concept: 'restoring force proportional to displacement', prerequisites: ['forces', 'energy'], keyFacts: ["F = -kx (restoring force)", "Period independent of amplitude", "Sine wave motion"] },
  '602': { unitName: 'Oscillations', lessonName: 'Spring Forces', concept: "Hooke's Law and spring potential energy", prerequisites: ['simple harmonic motion'], keyFacts: ["F = -kx", "PE = ½kx²", "k is spring constant in N/m"] },
  '603': { unitName: 'Oscillations', lessonName: 'Pendulums', concept: 'pendulum motion as approximated simple harmonic motion', prerequisites: ['spring forces'], keyFacts: ["T = 2π√(L/g)", "Period depends on length not mass", "Small angle approximation"] },
  '604': { unitName: 'Oscillations', lessonName: 'Resonance', concept: 'resonance when driving frequency matches natural frequency', prerequisites: ['pendulums'], keyFacts: ["Resonance = driving frequency matches natural frequency", "Amplitude spikes at resonance", "Tacoma Narrows bridge example"] },
  '701': { unitName: 'E&M Fields', lessonName: "Coulomb's Law", concept: "electric force between charges F = kq₁q₂/r²", prerequisites: ['Newton\'s Laws'], keyFacts: ["F = kq₁q₂/r²", "Like charges repel, opposite attract", "k = 9×10⁹ N·m²/C²"] },
  '702': { unitName: 'E&M Fields', lessonName: 'Electric Fields', concept: 'electric field as force per unit charge E = F/q', prerequisites: ["Coulomb's Law"], keyFacts: ["E = F/q = kQ/r²", "Field lines show direction of force on positive charge", "Superposition applies"] },
  '703': { unitName: 'E&M Fields', lessonName: 'Magnetic Forces', concept: 'magnetic force on moving charges F = qv × B', prerequisites: ['electric fields'], keyFacts: ["F = qvB·sin(θ)", "Right hand rule for direction", "Perpendicular to both v and B"] },
  '704': { unitName: 'E&M Fields', lessonName: 'Lorentz Force', concept: 'combined electric and magnetic force F = q(E + v × B)', prerequisites: ['magnetic forces'], keyFacts: ["F = q(E + v×B)", "Basis of all electromagnetic technology", "Used in particle accelerators"] },
}
